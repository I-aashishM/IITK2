...
$jscomp.polyfill("Array.prototype.find",function(a){return a?a:function(a,b){return $jscomp.findInternal(this,a,b).v}},"es6","es3");$(function(){var a=$(".input"),d=$(".description-flex-container").find("p");$(a).click(function(){var b=$(this),c=b.index();c=$(d).eq(c);$(b).add(c).addClass("active");$(a).not(b).add($(d).not(c)).removeClass("active")})});
